...
exports.resolveModelId = exports.getModelDescription = exports.getModelLabel = exports.getSupportedModelsForProvider = exports.DEFAULT_FREE_CLAUDE_CONFIG = exports.FreeClaudeProvider = void 0;
exports.createFreeClaudeProvider = createFreeClaudeProvider;
/**
...
class FreeClaudeProvider {
    ...
    async start(config) {
        ...
        const { resolveModelId } = await Promise.resolve().then(() => __importStar(require('./modelMapping')));
        const freeProvider = (this.config.freeProvider ?? 'openrouter');
        this.resolvedModelId = resolveModelId(this.config.model || 'claude-fable-5', freeProvider, this.config.modelMapping);
    ...
    async spawnFccServer() {
        ...
        await pm.spawn('fcc-server', fccServerCmd, fccServerArgs, {
            cwd: projectPath,
            env: {
                ...process.env,
    ...
    async spawnClaudeCli() {
        ...
        await pm.spawn('claude', command, args, options, 
     ...
     */
    async buildClaudeCommand(proxyUrl, projectPath) {
        const isWindows = process.platform === 'win32';
    ...
    setupProcessManagerListeners() {
        ...
        const onOutput = (processName, output) => {
    ...
    // ========== Cleanup ==========
    cleanupProcessManagerListeners() {
        this.pmCleanups.forEach((cleanup) => cleanup());
        this.pmCleanups = [];
    }
}
exports.FreeClaudeProvider = FreeClaudeProvider;
/**
 * Factory para registro no ProviderManager.
 */
function createFreeClaudeProvider(providerManager) {
...
Object.defineProperty(exports, "getSupportedModelsForProvider", { enumerable: true, get: function () { return modelMapping_1.getSupportedModelsForProvider; } });
Object.defineProperty(exports, "getModelLabel", { enumerable: true, get: function () { return modelMapping_1.getModelLabel; } });
Object.defineProperty(exports, "getModelDescription", { enumerable: true, get: function () { return modelMapping_1.getModelDescription; } });
Object.defineProperty(exports, "resolveModelId", { enumerable: true, get: function () { return modelMapping_1.resolveModelId; } });
//# sourceMappingURL=FreeClaudeProvider.js.map